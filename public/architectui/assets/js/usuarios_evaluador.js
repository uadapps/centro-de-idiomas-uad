...
$(document).on("change", "#campus", function () 
{
    $("option:selected", this).each(function () 
	{
        ...
        $(document).ready(function () {
            $.ajax({
                url: "/UsuariosEvaluador/usuarios_evaluador",
                type: "POST",
                data: {
                    id
                },
...
$(document).on("change", "#usuario", function () 
{
    $("option:selected", this).each(function () 
	{
        ...
        $(document).ready(function () {
            $.ajax({
                url: "/UsuariosEvaluador/grupos_trabajo",
                type: "POST",
                data: {
                    id
                },
...
{
    $.ajax({
        url: "/UsuariosEvaluador/modal_actualizar",
        type: "POST",
        data: {
            id
        },
...
{
    return $.ajax({
        url: "/UsuariosEvaluador/grupos_trabajo_todos",
        type: "POST",
        success: function (data) {
            $(".grupo_act").html(data);
        }
